...
public class RedisCacheEngineTest {
   ...
   @Test
   public void testKey() {
      engine.set(appKey, secKey1, "name", "luochen", 0);
      engine.set(appKey, secKey2, "name", "tonya", 0);
      ...
      engine.set(null, null, "name", "nokey", 0);
   ...
   public void testList() {
      ...
      engine.addToList(appKey, secKey1, "list", "a", 0, 0);
      engine.addToList(appKey, secKey1, "list", "b", -1, 0);
      List<Object> list = engine.getList(appKey, secKey1, "list");
   ...
   public void testSet() {
      ...
      engine.addToSet(appKey, secKey1, "set", "a", 0);
      engine.addToSet(appKey, secKey1, "set", "a", 0);
      engine.addToSet(appKey, secKey1, "set", "b", 0);
      ...
      Set<Object> set = engine.getSet(appKey, secKey1, "set");
   ...
   public void testPerformance() {
      ...
      for (int i = 0; i < count; i++) {
         engine.set(null, null, values[i], "luochen", 0);
      }
      long end = System.currentTimeMillis();
      System.out.println("Time of sharded " + count + " excution =" + String.valueOf(end - begin) + "ms");
   }
}
